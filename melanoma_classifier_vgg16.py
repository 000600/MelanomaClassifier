...
Original file is located at
    https://colab.research.google.com/drive/1xYm1SKZVDL-UCWzQH17LFCq-cuHw96xs
"""
...
malignant_paths = []
for r, d, f in os.walk(r'/content/drive/MyDrive/ML/Melanoma Cancer Data/train/malignant'): # Get malignant images
    for fi in f:
        if '.jpg' in fi:
...
benign_paths = []
for r, d, f in os.walk(r'/content/drive/MyDrive/ML/Melanoma Cancer Data/train/benign'): # Get benign images
    for fi in f:
        if '.jpg' in fi:
...
# Create testing data
malignant_paths = []
for r, d, f in os.walk(r'/content/drive/MyDrive/ML/Melanoma Cancer Data/test/malignant'): # Get malignant images
    for fi in f:
        if '.jpg' in fi:
            malignant_paths.append(os.path.join(r, fi)) # Add tumor images to the paths list
...
benign_paths = []
for r, d, f in os.walk(r'/content/drive/MyDrive/ML/Melanoma Cancer Data/test/benign'): # Get benign images
    for fi in f:
        if '.jpg' in fi:
            benign_paths.append(os.path.join(r, fi))
